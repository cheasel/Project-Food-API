    ...
    $(document).ready(function(){
        ...
        $("#username").change(function(){
            ...
            $.post( "check.php", { user: $("#username").val() }, function (data){
                console.log(data);
                if(data=='1'){
                    $("#message").html("<span style='font-size:13px; color: red'> Username not available</span>");
                    $("#username").css({'border':'1px solid red'});
                }
                else if(data=='0'){
                    $("#message").html("<span style='font-size:13px; color: green'> Username available</span>");
        ...
        $("#email").change(function(){
            ...
            $.post( "check.php", { email: $("#email").val() }, function (data){
                console.log(data);
                if(data=='1'){
                    $("#message2").html("<span style='font-size:13px; color: red'> Email not available</span>");
                    $("#email").css({'border':'1px solid red'});
                }
                else if(data=='0'){
                    $("#message2").html("<span style='font-size:13px; color: green'> Email available</span>");
