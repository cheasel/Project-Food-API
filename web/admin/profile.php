                                    ...
                                    <center class="m-t-30">
                                        <label for="news_filename">
                                            ...
                                            <?php }elseif ($fileimage != "") { ?>
                                                <img src="<?php echo $fileimage; ?>" id="blah" alt="your image" class="img-circle" width="250" height="250" />
                                            <?php } ?>
                                        </label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="firstname" value="<?php echo $firstname;  ?>" type="text" placeholder="<?php $firstname ?>" class="form-control form-control-line" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Surname</label>
                                        <div class="col-md-12">
                                            <input name="lastname" value="<?php echo $lastname;  ?>" type="text" placeholder="<?php $lastname ?>" class="form-control form-control-line" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" id="email" name="email" value="<?php echo $email;  ?>" class="form-control form-control-line" name="example-email" id="example-email" disabled>
                                        </div>
                                    </div>
                                    <!--<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="age" value="<?php if ($age!=0) {echo $age;}  ?>" type="text" placeholder="<?php $age ?>" class="form-control form-control-line" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-6">
                                                    <input type="radio" name="gender" value="1" id="male" <?php if ($gender == "1") { ?>checked <?php } ?> disabled> 
                                                    <label class="col-md-12" for="male">ชาย</label>
                                                </div>
                                                <div class="col-6">
                                                    <input type="radio" name="gender" value="2" id="female" <?php if ($gender == "2") { ?>checked <?php } ?> disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="height" value="<?php if ($height!=0) {echo $height;}  ?>" type="text" placeholder="<?php $height ?>" class="form-control form-control-line" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Weight</label>
                                        <div class="col-md-12">
                                            <input name="weight" value="<?php if ($weight!=0) {echo $weight;}  ?>" type="text" placeholder="<?php $weight ?>" class="form-control form-control-line" disabled>
                                        </div>
                                    </div>
                                    <!--<div class="form-group">
