    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <form action="../main/register.php" enctype="multipart/form-data" class="form-horizontal form-material" method="POST" onsubmit="return Validate()" name="vform">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="firstname" value="" type="text" placeholder="<?php $firstname ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Surname</label>
                                        <div class="col-md-12">
                                            <input name="lastname" value="" type="text" placeholder="<?php $lastname ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" id="email" name="email" value="" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="age" value="" type="text" placeholder="<?php $age ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="height" value="" type="text" placeholder="<?php $height ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Weight</label>
                                        <div class="col-md-12">
                                            <input name="weight" value="" type="text" placeholder="<?php $weight ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Role</label>
                                        <div class="col-md-12">
                                            <select name="role" class="form-control form-control-line col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button type="submit" name="submit" value="update" class="btn btn-success">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
